...
//		navegador.get("http://localhost:3000/admin/trocas/solicitacoes");
		...
		navegador.findElement(By.xpath("//*[@id=\"root\"]/div/header/div[1]/div[2]/ul/li[3]/div/div/button")).click();
		Thread.sleep(1500);
		navegador.findElement(By.xpath("//*[@id=\"menu-list\"]/ul/li[2]")).click();
		Thread.sleep(1500);
		navegador.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/ul/li[5]/a")).click();
		Thread.sleep(1500);
		navegador.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/ul/li[5]/div/ul/li[1]/a")).click();
		Thread.sleep(1500);
		navegador.findElement(By.xpath("//*[@id=\"tableList\"]/tr/td[2]")).click();
		Thread.sleep(2000);
		navegador.findElement(By.xpath("/html/body/div[3]/div/div[1]/div/div/div[3]/button")).click();
		Thread.sleep(1500);
...
//		navegador.findElement(By.id("entrar")).click();
		...
		navegador.findElement(By.xpath("//*[@id=\"root\"]/div/header/div[1]/div[2]/ul/li[3]/div/div/button")).click();
		Thread.sleep(1500);
		navegador.findElement(By.xpath("//*[@id=\"menu-list\"]/ul/li[1]")).click();
		Thread.sleep(1500);
		navegador.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/ul/li[5]/a")).click();
		Thread.sleep(1500);
